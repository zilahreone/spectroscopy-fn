...
export default function Footer() {
  return (
    <footer>
      <div className="flex justify-between px-[250px] text-sm font-medium p-2 footer-static custom-container">
        <div className='flex flex-col gap-y-2 text-white'>
          <div className='flex gap-x-6'>
            ...
            <div>
              ...
              <p>National Electronics and Computer Technology Center: NECTEC</p>
              <p>112 Phahonyothin Road, Khlong Nueng, Khlong Luang District, Pathumthani 12120, Thailand.</p>
            </div>
          </div>
          <div className='flex gap-x-6'>
            <div>
            ...
            <div>
              <p>Call Center: 662-564-6900</p>
              <p>Fax: 662-564-6901-3</p>
            </div>
          </div>
          <div className='flex gap-x-6'>
            <div>
