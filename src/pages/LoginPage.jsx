        ...
        <div class="flex justify-center h-screen">
          <div class="hidden bg-cover lg:block lg:w-2/3"
            ...
            <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
              <div>
                <h2 class="text-4xl font-bold text-white">Terahertz Technology Research Team (TRT)</h2>

                <p class="max-w-xl mt-3 text-gray-300">A research team focused on Terahertz basic research, efficient development and excellent technology having impact on economy, society, and security in country and provincial region for sustainable development.</p>
              </div>
            </div>
          </div>
          ...
          <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
            <div class="flex-1">
              <div class="text-center">
                <h2 class="text-4xl font-bold text-center text-gray-700 dark:text-white">Spectroscopy</h2>
