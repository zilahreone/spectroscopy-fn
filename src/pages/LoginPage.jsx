      ...
      <div className="grid lg:grid-cols-2 md:grid-cols-2 items-center gap-4">
        ...
        <form className="max-w-xl w-full p-6 mx-auto">
          <div className="mb-12">
            ...
            <p className="text-sm mt-6">Don't have an account <a href="javascript:void(0);" className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
          </div>
          <div>
