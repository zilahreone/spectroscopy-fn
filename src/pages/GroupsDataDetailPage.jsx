...
export default function GroupsDataDetailPage() {
  ...
  useEffect(() => {
    (async () => {
      let plot = []
      // Do stuff
      const [measurement] = experimentData.measurements
      for (const experiment of experimentData.measurements) {
        ...
        if (measurement?.raman?.typeData === 'single') {
          lines.forEach(line => {
            const [wave, intensity] = line.split(/\t/g).filter(tab => tab)
            if (!wave?.startsWith('#')) {
              plotObj.x.push(wave2freq(Number(wave)))
        ...
        <table className="table-zebra w-full text-sm">
          ...
          </tbody>
          {
            experimentData.measurements?.map((measurement, index) => {
              // let ramanRender = <></>
              // if (experimentData.technique.name === 'raman') {
              // }
              return (
                ...
                <>
                  <tbody className="" key={`measurement-${index}`}>
                    <tr className="h-8">
                      <td className="pl-8 font-medium">Name</td>
                      <td className="">{measurement.name}</td>
                    </tr>
                    <tr className="h-8">
                      <td className="pl-8 font-medium">Spectrum Description</td>
                      <td className="">{measurement.spectrumDescription}</td>
                    </tr>
                    <tr className="h-8">
                      <td className="pl-8 font-medium">Remark</td>
                      <td className="">{measurement.remark}</td>
                    </tr>
                  </tbody>
                  {
                    experimentData.technique.name === 'raman' && (
                      <tbody>
                        <tr className="h-8">
                          <td className="pl-8 font-medium">Measurement Condition</td>
                          <td className=""></td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-16 font-medium">Wave Length</td>
                          <td className="">{measurement.raman?.measurementCondition?.waveLength}</td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-16 font-medium">Laser Power</td>
                          <td className="">{measurement.raman?.measurementCondition?.laserPower}</td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-16 font-medium">Exposure Time</td>
                          <td className="">{measurement.raman?.measurementCondition?.exposureTime}</td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-16 font-medium">Lens</td>
                          <td className="">{measurement.raman?.measurementCondition?.lens}</td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-16 font-medium">Accumulations</td>
                          <td className="">{measurement.raman?.measurementCondition?.accumulations}</td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-8 font-medium">Measurement Technique</td>
                          <td className=""></td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-16 font-medium">Sers</td>
                          <td className=""></td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-24 font-medium">Chip</td>
                          <td className="">{measurement.raman?.measurementTechnique?.sers?.chip}</td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-24 font-medium">Nanoparticles</td>
                          <td className="">{measurement.raman?.measurementTechnique?.sers?.nanoparticles}</td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-24 font-medium">Papers</td>
                          <td className="">{measurement.raman?.measurementTechnique?.sers?.papers}</td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-24 font-medium">Other</td>
                          <td className="">{measurement.raman?.measurementTechnique?.sers?.other}</td>
                        </tr>
                        <tr className="h-8">
                          <td className="pl-8 font-medium">Type of Data</td>
                          <td className="">{measurement.raman?.typeData}</td>
                        </tr>
                      </tbody>
                    )
                  }
